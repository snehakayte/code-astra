...
$(document).ready(function() {
	...
	$('#dateRangeForm,#inboundButtonsection, #outboundButtonsection, #indefaultsection, #outdefaultsection, #inapikeysection, #outapikeysection, #inapikeystatussection, #outapikeystatussection, #intxnRefNosection, #outtxnRefNosection').hide();


	if (userGroups.length === 1 && userGroups[0] === "PAYBY") {
		setClientName('PAYBY');
		updateClientInfo(clientName, 'PAYBY.png');
	...
	$('#dateRangeForm').submit(function(event) {
		...
		daysAgo.setDate(currentDate.getDate() - 16);
